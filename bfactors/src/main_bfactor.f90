! Amir Shahmoradi, Monday 7:44 PM, January 27, 2014, WilkeLab, UT Austin.
...
if (command_argument_count()/=3) then
	...
	write(*,*) "Correct use:"
	write(*,'(1A90)') "./a.out <input pdb file> <atom name (e.g., CA, N, or ALL> <output bfactor file>"
	write(*,*)
	stop
end if
...
! FIRST DETERMINE THEW NUMBER OF ATOMS IN THE PDB FILE (EXCLUDING THE IONS: ONLY Na+ & Cl- ARE CONSIDERED AT THE MOMENT).
	...
	do
		...
		elseif (ios>0) then
			...
			!	!write(21,'(A3)') 'TER'
			!	write(*,*) 'encountered TER in pdb file'
			!elseif (trim(adjustl(record))=='END') then
			!	!write(21,'(A3)') 'END'
			!	write(*,*) 'END of pdb file'
			!	exit
	...
	close(11); close(21)
	write(*,*); write(*,'(1A10,1I8)') "natoms: ",natoms; write(*,'(1A10,1I8)') "nions: ",nions
	write(*,'(1A10,1I8)') "ntot: ",natoms+nions; write(*,'(1A10,1I8)') "last_res: ",nres; write(*,*)
