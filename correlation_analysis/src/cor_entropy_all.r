...
plot(0,xaxt='n',yaxt='n',bty='n',pch='',ylab=expression(paste("Correlation (", rho, ") with entropy")),xlab='Correlating Variable', xlim=c(1,5.2),ylim=c(-.5,.45)) #, main = 'sequence entropy - contact number association', cex.main=0.8)
...
axis( 1,
      at=c(1, 2, 3, 4, 5),
      padj=c(0,0,0,0,0,0),
      c("MD RSA", "MD WCN", expression(paste("MD var(", chi[1],")")), "MD RMSF", "B factor")) #,  "CS rmsf"))
