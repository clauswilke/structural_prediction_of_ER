...
# Amir Shahmoradi, Friday 12:45 PM, April 18, 2014, iCMB, UT Austin:  This version was specifically modified for adding the rate4site evolutionary rates.
...
r4s_HP = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/HP_R.rates', header=T)
r4s_1RD8_AB = r4s_HP$SCORE[!is.na(map_1RD8_AB$pdb_pos)]; r4s_1RD8_AB = as.data.frame(r4s_1RD8_AB)

data_1RD8_AB = data.frame(protein="1RD8_AB", res_num=dihedral_1RD8_AB$res_Num, res_name=dihedral_1RD8_AB$res_name,
                       r4s=r4s_1RD8_AB$r4s_1RD8_AB, omega=omega_1RD8_AB$omega, entropy=entropy_1RD8_AB$entropy_1RD8_AB, desent=desent_1RD8_AB$entropy,
...
r4s_WNPB = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/WNPB_R.rates', header=T)
r4s_2FP7_B = r4s_WNPB$SCORE[!is.na(map_2FP7_B$pdb_pos)]; r4s_2FP7_B = as.data.frame(r4s_2FP7_B)

data_2FP7_B = data.frame(protein="2FP7_B", res_num=dihedral_2FP7_B$res_Num, res_name=dihedral_2FP7_B$res_name,
                       r4s=r4s_2FP7_B$r4s_2FP7_B, omega=omega_2FP7_B$omega, entropy=entropy_2FP7_B$entropy_2FP7_B, desent=desent_2FP7_B$entropy,
...
r4s_JEHN = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/JEHN_R.rates', header=T)
r4s_2Z83_A = r4s_JEHN$SCORE[!is.na(map_2Z83_A$pdb_pos)]; r4s_2Z83_A = as.data.frame(r4s_2Z83_A)

data_2Z83_A = data.frame(protein="2Z83_A", res_num=dihedral_2Z83_A$res_Num, res_name=dihedral_2Z83_A$res_name,
                       r4s=r4s_2Z83_A$r4s_2Z83_A, omega=omega_2Z83_A$omega, entropy=entropy_2Z83_A$entropy_2Z83_A, desent=desent_2Z83_A$entropy,
...
r4s_RVFVNP = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/RVFVNP_R.rates', header=T)
r4s_3LYF_A = r4s_RVFVNP$SCORE[!is.na(map_3LYF_A$pdb_pos)]; r4s_3LYF_A = as.data.frame(r4s_3LYF_A)

data_3LYF_A = data.frame(protein="3LYF_A", res_num=dihedral_3LYF_A$res_Num, res_name=dihedral_3LYF_A$res_name,
                       r4s=r4s_3LYF_A$r4s_3LYF_A, omega=omega_3LYF_A$omega, entropy=entropy_3LYF_A$entropy_3LYF_A, desent=desent_3LYF_A$entropy,
...
r4s_CCHFN = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/CCHFN_R.rates', header=T)
r4s_4AQF_B = r4s_CCHFN$SCORE[!is.na(map_4AQF_B$pdb_pos)]; r4s_4AQF_B = as.data.frame(r4s_4AQF_B)

data_4AQF_B = data.frame(protein="4AQF_B", res_num=dihedral_4AQF_B$res_Num, res_name=dihedral_4AQF_B$res_name,
                       r4s=r4s_4AQF_B$r4s_4AQF_B, omega=omega_4AQF_B$omega, entropy=entropy_4AQF_B$entropy_4AQF_B, desent=desent_4AQF_B$entropy,
...
r4s_MRNABD = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/MRNABD_R.rates', header=T)
r4s_4GHA_A = r4s_MRNABD$SCORE[!is.na(map_4GHA_A$pdb_pos)]; r4s_4GHA_A = as.data.frame(r4s_4GHA_A)

data_4GHA_A = data.frame(protein="4GHA_A", res_num=dihedral_4GHA_A$res_Num, res_name=dihedral_4GHA_A$res_name,
                       r4s=r4s_4GHA_A$r4s_4GHA_A, omega=omega_4GHA_A$omega, entropy=entropy_4GHA_A$entropy_4GHA_A, desent=desent_4GHA_A$entropy,
...
r4s_INP = read.table('C:/Users/Amir/Documents/GitHub/structural_prediction_of_ER/evolutionary_rates/rate4site/INP_R.rates', header=T)
r4s_4IRY_A = r4s_INP$SCORE[!is.na(map_4IRY_A$pdb_pos)]; r4s_4IRY_A = as.data.frame(r4s_4IRY_A)

data_4IRY_A = data.frame(protein="4IRY_A", res_num=dihedral_4IRY_A$res_Num, res_name=dihedral_4IRY_A$res_name,
                       r4s=r4s_4IRY_A$r4s_4IRY_A, omega=omega_4IRY_A$omega, entropy=entropy_4IRY_A$entropy_4IRY_A, desent=desent_4IRY_A$entropy,
