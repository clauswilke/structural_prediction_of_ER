...
screen(1)
	...
	plot(0,xaxt='n',yaxt='n',bty='n',pch='',ylab=expression(paste("Entropy explained variance (", r^2, ")")),xlab='Principal Component (PC)', xlim=c(1,6.2),ylim=c(-.1,.2)) #, main = 'sequence entropy - contact number association', cex.main=0.8)
