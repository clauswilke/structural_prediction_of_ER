...
rsa_1RD8 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/1RD8_sum.rsa',header=T)
...
rsa_2JLY = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/2JLY_sum.rsa',header=T)
...
rsa_2Z83 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/2Z83_sum.rsa',header=T)
...
rsa_3GOL = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/3GOL_sum.rsa',header=T)
rsa_3GSZ = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/3GSZ_sum.rsa',header=T)
rsa_3I5K = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/3I5K_sum.rsa',header=T)
...
rsa_4AQF_B = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/4AQF_B_sum.rsa',header=T)
...
rsa_4GHA_A = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/4GHA_A_sum.rsa',header=T)
...
rsa_4IRY = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/4IRY_sum.rsa',header=T)
...
rsa_1AJ8_A = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/1AJ8_A_sum.rsa',header=T)
...
rsa_1AOR_A = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/1AOR_A_sum.rsa',header=T)
...
rsa_1CTS_A = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/1CTS_A_sum.rsa',header=T)
...
rsa_1MP9_A = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/1MP9_A_sum.rsa',header=T)
...
rsa_2JLY_temp_50 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/2JLY_temp_50_sum.rsa',header=T)
...
rsa_2JLY_temp_100 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/2JLY_temp_100_sum.rsa',header=T)
...
rsa_2JLY_temp_200 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/2JLY_temp_200_sum.rsa',header=T)
...
rsa_2JLY_temp_450 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/2JLY_temp_450_sum.rsa',header=T)
...
rsa_1AOR_A_temp_373 = read.table('molecular_dynamics/Amber/postproc/rsa_summaries/1AOR_A_temp_373_sum.rsa',header=T)
